...
function makeIcsFile(uid, mid, zlink, pass, date, dstr, dend, ttl, desc) {
  var event = "BEGIN:VCALENDAR\n" + "CALSCALE:GREGORIAN\n" + "METHOD:PUBLISH\n" + "PRODID:-//Test Cal//EN\n" + "VERSION:2.0\n" + "BEGIN:VEVENT\n" + "UID:" + uid + "'\n" + "DTSTART;VALUE=DATE:" + convertDate(dstr) + "\n" + "DTEND;VALUE=DATE:" + convertDate(dend) + "\n" + "SUMMARY:" + ttl + "\n" + "DESCRIPTION:" + desc + " " + " " + mid + " " + zlink + " " + pass + "\n" + "END:VEVENT\n" + "END:VCALENDAR";
...
var zlink = urlParams.get('zlink');
var pass = urlParams.get('pass');
var date = urlParams.get('date');
var dstr = urlParams.get('dstr');
var dend = urlParams.get('dend');
var ttl = urlParams.get('ttl');
